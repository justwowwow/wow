...
uint256 hashGenesisBlock("0xb42edf78988664c2148f379a2d743285a255e5b31044f3b924cfaded3f3cb45a");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(486604799); // WOW: starting difficulty is 1 / 2^12
...
{
    // WOW: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // WOW: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // WOW: 3.5 days
static const int64 nTargetSpacing = 150; // WOW: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // WOW: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // WOW: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // WOW: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x59cb90a53c64271eb228c8f35217f8ce332148af4ec702a45a36b68d9f8d8588");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("fdc9d93631fdc45c8a3d76f4bba13511583662654cd738c3d93626b6ba526ca48871d17b096977735dc12bf31ff1c3040140e58eaed2537fea274581272e428f98") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1530999259;
        block.nBits    = 486604799;
        block.nNonce   = 1144101090;

        if (fTestNet)
        {
            block.nTime    = 1530999259;
            block.nNonce   = 2671476678;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x9a715d7336663292c19ba5b11aba0f49a62f48dc783767e169b7cfbfb9cd1016"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // WOW: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("WOWMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("WOWMiner : ProcessBlock, block not accepted");
    }
